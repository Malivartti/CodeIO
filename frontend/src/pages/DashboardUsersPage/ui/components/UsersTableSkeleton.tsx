          ...
          <div key={i} className="bg-surface border border-surface rounded-xl p-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="h-4 bg-surface-unaccent rounded w-48" />
              ...
              <tr key={i}>
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-surface-unaccent rounded-full" />
                    <div className="h-5 bg-surface-unaccent rounded w-32" />
                  </div>
                </td>
                <td className="px-6 py-4">
                  <div className="h-4 bg-surface-unaccent rounded w-40" />
                </td>
                <td className="px-6 py-4">
                  <div className="h-6 bg-surface-unaccent rounded w-16" />
                </td>
                <td className="px-6 py-4">
                  <div className="h-6 bg-surface-unaccent rounded w-20" />
                </td>
                <td className="px-6 py-4">
